...
(function () {
  ...
  description = function (message) {
    ...
    description.init.call(ds, message);
    return ds;
  };

  /**
   * Initializes a description object.
   * @this {Object} The description object being initialized.
   */
  description.init = function (message) {
